...
function MentorshipSection() {
  return (
    <div className="container mt-5">
            ...
            <div className="carousel-item carousel-item-next carousel-item-start">
              ...
              <div className="container">
                <div className="carousel-caption text-end">
                  ...
                  <p>
                    Click the button below to see the mentorship gallery and go
                    to the details.
                  </p>
                  <p>
      ...
      <div className="py-5" id="hanging-icons">
        <h2 className="pb-2 border-bottom display-6 fw-bold lh-1 mb-3">
        ...
        <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div className="col d-flex align-items-start">
            ...
            <div>
              <h3 className="fs-2">Make a difference in a mentee’s life</h3>
              <p>
          ...
          <div className="col d-flex align-items-start">
            ...
            <div>
              <h3 className="fs-2">Join a network of inspiring students</h3>
              <p>
          ...
          <div className="col d-flex align-items-start">
            ...
            <div>
              <h3 className="fs-2">Training, resources and partner events</h3>
              <p>
